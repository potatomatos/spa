...
//                }
    ...
    var change_page = function(container_id, previous_selection, current_selection, update_nav_items, trigger_change_page) {
        ...
        if(trigger_change_page) {
            elem.triggerHandler("onChangePage", {currentPage: current_selection, rowsPerPage: s.rowsPerPage, totalRows:s.totalRows});
        } else {
            elem.triggerHandler("onLoad", {currentPage: current_selection, rowsPerPage: s.rowsPerPage, totalRows:s.totalRows});
        }
